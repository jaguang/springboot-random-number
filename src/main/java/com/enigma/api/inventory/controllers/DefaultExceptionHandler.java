...
// Response entity exception handler digunakan untuk menset exception dengan http status
...
public class DefaultExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handleBindingResult(BindingResult result, HttpStatus status){
        ...
        result.getFieldErrors().forEach((fieldError) -> {
            ...
            // isi field error berdasarkan message properties
        ...
        // pass parameter ke message properties {}
//        String message = messageSource.getMessage("error." + status.value(), new Object[] {"isi pesan1", "isi pesan2"},
//                LocaleContextHolder.getLocale());
