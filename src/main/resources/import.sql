...
INSERT INTO quantity (item_id, quantity, created_date, total_price) VALUES (1, 1, '2021-01-14', ((SELECT (item.price * 1) FROM item WHERE item.id = 1)));
INSERT INTO quantity (item_id, quantity, created_date, total_price) VALUES (2, 5, '2021-01-14', ((SELECT (item.price * 5) FROM item WHERE item.id = 2)));
INSERT INTO quantity (item_id, quantity, created_date, total_price) VALUES (3, 10, '2021-01-14', ((SELECT (item.price * 10) FROM item WHERE item.id = 3)));
INSERT INTO quantity (item_id, quantity, created_date, total_price) VALUES (4, 10, '2021-01-14', ((SELECT (item.price * 10) FROM item WHERE item.id = 4)));
INSERT INTO quantity (item_id, quantity, created_date, total_price) VALUES (5, 50, '2021-01-14', ((SELECT (item.price * 50) FROM item WHERE item.id = 5)));
INSERT INTO quantity (item_id, quantity, created_date, total_price) VALUES (6, 20, '2021-01-14', ((SELECT (item.price * 20) FROM item WHERE item.id = 6)));
INSERT INTO quantity (item_id, quantity, created_date, total_price) VALUES (7, 15, '2021-01-14', ((SELECT (item.price * 15) FROM item WHERE item.id = 7)));
INSERT INTO quantity (item_id, quantity, created_date, total_price) VALUES (8, 100, '2021-01-14', ((SELECT (item.price * 100) FROM item WHERE item.id = 8)));
